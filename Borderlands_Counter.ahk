...
Gui, Add, Text,, Run# %RunNumber%			;Adds text of current run number
Gui, Show, W380 H80 X%Xpos% Y%Ypos% NA		;Shows window with set width and Height at Chosen XY Postion.
...
Gui, Add, Text,, Run# %RunNumber%
Gui, Show, W380 H80 X%Xpos% Y%Ypos% NA
return
